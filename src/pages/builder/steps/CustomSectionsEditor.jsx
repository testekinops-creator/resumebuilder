...
export default function CustomSectionsEditor() {
  ...
  useDialogFocus(removeDialogRef, {
    enabled: Boolean(sectionPendingRemoval),
    onClose: () => setSectionPendingRemoval(''),
    ...
    <div className="step-page">
      ...
      {sectionPendingRemoval && (
        <div className="custom-section-remove-backdrop" role="presentation" onMouseDown={() => setSectionPendingRemoval('')}>
          <div ref={removeDialogRef} className="custom-section-remove-dialog" role="dialog" aria-modal="true" aria-labelledby="custom-section-remove-title" tabIndex={-1} onMouseDown={event => event.stopPropagation()}>
            ...
            <div className="custom-section-remove-dialog-actions">
              <button ref={removeCancelRef} type="button" className="btn btn-ghost" onClick={() => setSectionPendingRemoval('')}>Cancel</button>
